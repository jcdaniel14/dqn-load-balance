...
ejemplo2 = np.array([{'id': 'uio1-port1', 'bw': 199, 'congestionado': True, 'region': 'uio', 'capacidad': 200},
                     {'id': 'uio1-port2', 'bw': 99, 'congestionado': True, 'region': 'uio', 'capacidad': 100},
                     {'id': 'uio1-port3', 'bw': 49, 'congestionado': True, 'region': 'uio', 'capacidad': 50},
                     {'id': 'uio1-port4', 'bw': 49, 'congestionado': True, 'region': 'uio', 'capacidad': 50},
                     {'id': 'uio1-port5', 'bw': 49, 'congestionado': True, 'region': 'uio', 'capacidad': 50},
                     {'id': 'uio1-port6', 'bw': 59, 'congestionado': True, 'region': 'uio', 'capacidad': 60},
                     {'id': 'uio2-port1', 'bw': 199, 'congestionado': True, 'region': 'uio', 'capacidad': 200},
                     {'id': 'uio2-port2', 'bw': 199, 'congestionado': True, 'region': 'uio', 'capacidad': 200},
                     ...
                     {'id': 'gye1-port3', 'bw': 99, 'congestionado': True, 'region': 'gye', 'capacidad': 100},
                     ...
                     {'id': 'gye3-port1', 'bw': 99, 'congestionado': True, 'region': 'gye', 'capacidad': 100}
                     ])
