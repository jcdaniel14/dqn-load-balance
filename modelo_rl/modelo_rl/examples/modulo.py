...
last_scores = []
for i in range(1):
    ejemplo2 = np.array([{'id': 'uio1-port1', 'bw': 92, 'congestionado': False, 'region': 'uio', 'capacidad': 200},  # 0
                         {'id': 'uio1-port2', 'bw': 25, 'congestionado': False, 'region': 'uio', 'capacidad': 100},  # 1
                         {'id': 'uio1-port3', 'bw': 26, 'congestionado': False, 'region': 'uio', 'capacidad': 50},  # 2
                         {'id': 'uio1-port4', 'bw': 26, 'congestionado': False, 'region': 'uio', 'capacidad': 50},  # 3
                         {'id': 'uio1-port5', 'bw': 26, 'congestionado': False, 'region': 'uio', 'capacidad': 50},  # 4
                         {'id': 'uio1-port6', 'bw': 26, 'congestionado': False, 'region': 'uio', 'capacidad': 60},  # 5
    ...
    acciones, scores, epoch, steps, err = modelo_rl.solve_congestion(ejemplo2, path, debug=True, epoch=5000)
    if err:
        logger.info(err)
    elif scores:
